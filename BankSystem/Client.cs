...
namespace BankSystem
{
    ...
    public interface IAccountTransaction<in T, TAccountNumber, TBalance>
    ...
    /// <typeparam name="TAccountNumber"></typeparam>
    /// <typeparam name="TBalance"></typeparam>
    public class Transactions<T, TAccountNumber, TBalance> : IAccountTransaction<T, TAccountNumber, TBalance>
        where T : Client<TAccountNumber, TBalance>
    {
